...
export default function VendorRegistrationPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Step 4: Create vendor document
      // Use user.uid as document ID to match security rules requirement (vendorId == userId)
      console.log("Step 4: Creating vendor document in Firestore...");
      ...
      // Handle Firestore errors
        ...
        errorMessage = "⚠️ Firestore Permission Error: The security rules have not been deployed yet. Please deploy the Firestore security rules from the firestore.rules file to your Firebase project. Your account was created in Firebase Auth, but vendor details could not be saved.";
      ...
      if (createdUser) {
        errorMessage += ` Your Firebase Auth account was created (UID: ${createdUser.uid}), but the vendor profile could not be saved.`;
      }
      ...
      <div className="max-w-3xl mx-auto relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">
            Create your vendor account to start selling on LiWAS Ride
          </p>
        </div>
            ...
            <div>
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
                >
                  Upload Documents (Business License, ID, etc.)
                </label>
                <input
                  id="documents"
                  type="file"
